...
% Destination competition.sage.out.intermediate.latexml.html5
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsfonts}
\usepackage{graphicx}
...
\makeatother
\begin{document}
\beginDISPLAY \begin{aligned}\displaystyle\frac{dX_{{2}}}{dt}&\displaystyle=-0.400000000000000\, X_{{1}}X_{{2}}-X_{{2}}^{{2}}+X_{{2}}\\
\displaystyle\frac{dX_{{1}}}{dt}&\displaystyle=-X_{{1}}^{{2}}-0.500000000000000\, X_{{1}}X_{{2}}+X_{{1}}\end{aligned}\endDISPLAY\clearpage
\end{document}
