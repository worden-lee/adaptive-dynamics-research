...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_0p1 = RealNumber('0.1'); _sage_const_12 = Integer(12); _sage_const_10 = Integer(10)# requires: $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
...
a_phase_plane.save( 'maclev-2-2-a-vs-a.png', figsize=(_sage_const_4 ,_sage_const_4 ) )
...
a_phase_plane_annotated.save( 'maclev-2-2-a-arrows.png', figsize=(_sage_const_10 ,_sage_const_10 )
