# This file was *autogenerated* from the file maclev-2-2-a-c-geom.sage
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8); _sage_const_0p1 = RealNumber('0.1'); _sage_const_12 = Integer(12); _sage_const_0p06 = RealNumber('0.06')# requires: maclevmodels.py lotkavolterra.py
...
ltx.write_equality( SR('A(0)'), lv_adap_c.A(_sage_const_0 ), A_to_u_bindings( lv_adap_c.A(_sage_const_0 ) ) )
ltx.write_equality( SR('A(1)'), lv_adap_c.A(_sage_const_1 ), A_to_u_bindings( lv_adap_c.A(_sage_const_1 ) ) )
ltx.write_equality( SR('S(A(0))'), lv_adap_c.S( lv_adap_c.A(_sage_const_0 ) ), lv_adap_c._lv_model.interior_equilibrium_bindings()( lv_adap_c.S( lv_adap_c.A(_sage_const_0 ) ) ) )
ltx.write_equality( SR('S(A(1))'), lv_adap_c.S( lv_adap_c.A(_sage_const_1 ) ), lv_adap_c._lv_model.interior_equilibrium_bindings()( lv_adap_c.S( lv_adap_c.A(_sage_const_1 ) ) ) ) 

ltx.write_equality( wrap_latex( 'D(u_0)' ), lv_adap_c.direct_effect(_sage_const_0 )
    #, A_to_u_bindings( lv_adap_c.direct_effect(0) )
)
ltx._output.flush()
ltx.write_equality( wrap_latex( 'I(u_0)' ), lv_adap_c.indirect_effect(_sage_const_0 )
    #, A_to_u_bindings( lv_adap_c.indirect_effect(0) )
)
ltx._output.flush()
ltx.write_equality( wrap_latex( r'\frac{dA}{dt}' ), lv_adap_c.dAdt(_sage_const_0 )
...
a_timeseries.save( 'maclev-2-2-a-c-a-vs-t.png', figsize=(_sage_const_4 ,_sage_const_4 ) )
a_timeseries.save( 'maclev-2-2-a-c-a-vs-t.svg', ymax=_sage_const_0 , ticks=_sage_const_0p06 , figsize=(_sage_const_2 ,_sage_const_2 ) )
...
a_phase_plane.save( 'maclev-2-2-a-c-a-vs-a.png', figsize=(_sage_const_4 ,_sage_const_4 ), xmax=_sage_const_0 , ymax=_sage_const_0  )
...
a_phase_plane_annotated.save( 'maclev-2-2-a-c-a-arrows.png', figsize=(_sage_const_8 ,_sage_const_8 )
