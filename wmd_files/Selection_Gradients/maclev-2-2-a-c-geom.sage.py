...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8); _sage_const_0p1 = RealNumber('0.1'); _sage_const_12 = Integer(12); _sage_const_0p06 = RealNumber('0.06')# requires: $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
