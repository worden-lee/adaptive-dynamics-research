...
maclev-1-2-p.sage maclev-1-2-p.sage.out maclev-1-2-p.sage.tried : $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
maclev-1-2-p.sage maclev-1-2-p.sage.out maclev-1-2-p.sage.tried : $(SageAdaptiveDynamics)/adaptivedynamics.py maclevmodels.py
