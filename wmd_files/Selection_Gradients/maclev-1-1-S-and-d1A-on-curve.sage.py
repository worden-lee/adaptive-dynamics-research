# This file was *autogenerated* from the file maclev-1-1-S-and-d1A-on-curve.sage
...
p = cp + vfp_S + vfp_d
p.axes_labels( [ '$a$', '$k$' ] );
p.save( 'maclev-1-1-S-and-d1A-on-curve.png', figsize=(_sage_const_4 ,_sage_const_4 ) );
