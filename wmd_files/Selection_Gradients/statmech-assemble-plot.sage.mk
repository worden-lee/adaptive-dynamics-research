...
statmech-assemble-plot.sage statmech-assemble-plot.sage.out statmech-assemble-plot.sage.tried : $(SageDynamics)/dynamicalsystems.py
statmech-assemble-plot.sage statmech-assemble-plot.sage.out statmech-assemble-plot.sage.tried : $(SageUtils)/latex_output.py
