...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_0p02 = RealNumber('0.02'); _sage_const_0p05 = RealNumber('0.05')# requires: maclev_a_c.py maclev_2_2_defs.py
