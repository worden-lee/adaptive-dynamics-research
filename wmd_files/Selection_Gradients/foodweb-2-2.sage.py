...
_sage_const_3 = Integer(3); _sage_const_0p1 = RealNumber('0.1'); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_0p2 = RealNumber('0.2')# requires: foodweb.py
...
foodweb = foodweb.FoodWebModel(
    ...
    bindings = dynamicalsystems.Bindings( { 'r':_sage_const_1 , 'k':_sage_const_1 /_sage_const_3 , 'm':_sage_const_1  } ) + dynamicalsystems.FunctionBindings( { 'a':SR('1 + cos( u - v )').function(SR('u'),SR('v')) } )
);
...
init_2_2 = dynamicalsystems.Bindings( { 'u_R_0_0':_sage_const_0p1 , 'u_R_1_0':_sage_const_0 , 'u_P_0_0':-_sage_const_0p1 , 'u_P_1_0':-_sage_const_0p2  } ) 
