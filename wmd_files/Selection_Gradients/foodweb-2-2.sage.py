...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_9 = Integer(9); _sage_const_0p1 = RealNumber('0.1'); _sage_const_0p08 = RealNumber('0.08'); _sage_const_10 = Integer(10); _sage_const_0p02 = RealNumber('0.02'); _sage_const_30 = Integer(30)# requires: foodweb.py
...
foodweb_2_2 = foodweb.FoodWebModel(
    ...
    bindings = (
	dynamicalsystems.Bindings( { 'r':_sage_const_1 , 'k':_sage_const_9 /_sage_const_10 , 'm':_sage_const_1  } ) +
...
init_2_2 = dynamicalsystems.Bindings( { 'u_0_R_0':-_sage_const_0p1 , 'u_0_R_1':_sage_const_0 , 'u_0_P_0':-_sage_const_0p08 , 'u_0_P_1':_sage_const_0p02  } ) 

print init_2_2( dynamicalsystems.Bindings( equil[_sage_const_0 ] ) )
