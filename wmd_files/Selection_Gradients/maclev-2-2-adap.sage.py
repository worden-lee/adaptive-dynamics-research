...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_19 = Integer(19); _sage_const_20 = Integer(20); _sage_const_4 = Integer(4)# requires: $(SageDynamics)/dynamicalsystems.py
