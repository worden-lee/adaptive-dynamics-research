...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_0p1 = RealNumber('0.1'); _sage_const_0p4 = RealNumber('0.4'); _sage_const_0p6 = RealNumber('0.6'); _sage_const_0p9 = RealNumber('0.9'); _sage_const_30 = Integer(30); _sage_const_19 = Integer(19); _sage_const_20 = Integer(20)# requires: $(SageDynamics)/dynamicalsystems.py
...
try:
    ...
    adap_equilibria = maclev_adap_c.equilibria( ranges={ u_0:(_sage_const_0p1 ,_sage_const_0p4 ,_sage_const_0p6 ,_sage_const_0p9 ), u_1:(_sage_const_0p1 ,_sage_const_0p4 ,_sage_const_0p6 ,_sage_const_0p9 ) } )
    ...
    for eq in adap_equilibria:
        ...
        u_phase_plane += point( Bindings( eq )( vector( [ hat(u_0), hat(u_1) ] ) ), color='black', size=_sage_const_30  )

    print 'solve'
    sys.stdout.flush()

    try:
        c_evolution = maclev_adap_c.solve( [_sage_const_0 , initial_conditions( u_0 ), initial_conditions( u_1 ) ], end_points=integrate_adapdyn_to, step=integrate_adapdyn_step )
