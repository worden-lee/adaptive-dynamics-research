...
_sage_const_1p79325 = RealNumber('1.79325'); _sage_const_1p993 = RealNumber('1.993'); _sage_const_1p9925 = RealNumber('1.9925'); _sage_const_5 = Integer(5); _sage_const_1p79375 = RealNumber('1.79375')# requires: foodweb-2-2.sobj
...
lotkavolterra.plot_aij_with_arrows( traj_2_2, flv, 'foodweb-2-2-a-vs-a.png', xmin=-_sage_const_1p993 , xmax=-_sage_const_1p9925 , ymin=_sage_const_1p79325 , ymax=_sage_const_1p79375  )
