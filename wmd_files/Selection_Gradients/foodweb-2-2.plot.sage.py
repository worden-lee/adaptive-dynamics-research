...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_1p9925 = RealNumber('1.9925'); _sage_const_1p79375 = RealNumber('1.79375'); _sage_const_1p79325 = RealNumber('1.79325'); _sage_const_1p993 = RealNumber('1.993')# requires: foodweb-2-2.sobj
...
x0 = dynamicalsystems.hat( sym_lv._lv_model._vars[_sage_const_0 ] )
x1 = dynamicalsystems.hat( sym_lv._lv_model._vars[_sage_const_1 ] )
i0 = sym_lv._lv_model._population_indices[_sage_const_0 ] 
i1 = sym_lv._lv_model._population_indices[_sage_const_1 ] 
...
ppx.save( 'foodweb-2-2-x-vs-t.png', figsize=(_sage_const_5 ,_sage_const_5 ) )
...
atp.save( 'foodweb-2-2-a-vs-t.png', figsize=(_sage_const_5 ,_sage_const_5 ) )

lotkavolterra.plot_aij_with_arrows( traj_2_2, flv, 'foodweb-2-2-a-vs-a.png' )

lotkavolterra.plot_aij_with_arrows( traj_2_2, flv, 'foodweb-2-2-a-vs-a-detail.png', xmin=-_sage_const_1p993 , xmax=-_sage_const_1p9925 , ymin=_sage_const_1p79325 , ymax=_sage_const_1p79375  )
