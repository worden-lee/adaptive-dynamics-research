# This file was *autogenerated* from the file maclev-a-only-popdyn.sage
from sage.all_cmdline import *   # import sage library
_sage_const_30 = Integer(30); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4)# requires: maclev_a_only_defs.py
...
rescomp_initial_system.plot_R_ZNGIs( filename='maclev-a-only-r-zngis.png', figsize=(_sage_const_4 ,_sage_const_4 ), ymin=_sage_const_0 , ymax=_sage_const_4 , xmin=_sage_const_0 , xmax=_sage_const_4  )
...
c_curve.save( 'maclev-a-only-c-vs-u.png', figsize=(_sage_const_4 ,_sage_const_4 ), ymin=_sage_const_0  )
