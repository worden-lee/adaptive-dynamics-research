...
# produces: maclev-a-only-p.sage.out.tex maclev-a-only-c-vs-t.png
# produces: maclev-a-only-c-vs-c.png maclev-a-only-total-c-vs-u.png
from maclev_a_only_defs import *

load_session( 'maclev-a-only-adap' )

ltx = latex_output( 'maclev-a-only-p.sage.out.tex' )
...
c_timeseries.save( 'maclev-a-only-c-vs-t.png', figsize=(4,4) )
...
c_phase_plane.save( 'maclev-a-only-c-vs-c.png', figsize=(4,4) )
...
c_curve.save( 'maclev-a-only-total-c-vs-u.png', figsize=(4,4), ymin=0 )

ltx.close()
save_session( 'maclev-a-only-p' )
