...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_0p06 = RealNumber('0.06'); _sage_const_6 = Integer(6)# requires: $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
