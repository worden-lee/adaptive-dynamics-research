# This file was *autogenerated* from the file large-evol-plot.sage
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_100 = Integer(100); _sage_const_500 = Integer(500); _sage_const_3p2 = RealNumber('3.2'); _sage_const_0p05 = RealNumber('0.05')# requires: large-evol.sobj
...
atp.axes_labels( [ '$t$', '$a$' ] )
atp.save( 'large-a-vs-t.svg', figsize=(_sage_const_5 ,_sage_const_5 ) )

aap = lotkavolterra.plot_aij_with_arrows( sm_traj, slv, scale=_sage_const_0p05  )
aap.axes_labels( [ '$a_{ij}$', '$a_{ji}$' ] )
aap.save( 'large-a-vs-a.svg', figsize=(_sage_const_5 ,_sage_const_5 ) )
...
ppx.save( 'large-pred-prey-x-vs-t.png', figsize=(_sage_const_5 ,_sage_const_5 ) )
