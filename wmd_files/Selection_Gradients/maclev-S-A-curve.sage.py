...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_5 = Integer(5); _sage_const_1p05 = RealNumber('1.05'); _sage_const_0p3 = RealNumber('0.3'); _sage_const_0p55 = RealNumber('0.55')# requires: maclevmodels.py maclev-1-1-mc-adap-geom.sobj
...
maclev_SA = SAvf
maclev_SA += plot_v_curve( FunctionBindings( { ('c',(u,)):SR(_sage_const_1 ), ('m',(u,)):u } ), (u,_sage_const_1p05 ,_sage_const_2 ) )
maclev_SA += plot_v_curve( FunctionBindings( { ('c',(u,)):u, ('m',(u,)):_sage_const_1 /u } ), (u,-_sage_const_2 ,_sage_const_2 ) )
