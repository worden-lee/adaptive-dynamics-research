...
_sage_const_100 = Integer(100); _sage_const_5 = Integer(5)# requires: foodweb.sobj
...
pred_prey_traj = foodweb_adap.solve( [ pred_prey_init( v ) for v in foodweb_adap._vars ], end_time=_sage_const_100  ) #, step=0.003 )
