...
_sage_const_1p9945 = RealNumber('1.9945'); _sage_const_1p9955 = RealNumber('1.9955'); _sage_const_5 = Integer(5); _sage_const_1p796 = RealNumber('1.796'); _sage_const_1p795 = RealNumber('1.795'); _sage_const_400 = Integer(400)# requires: foodweb.sobj
...
pred_prey_traj = foodweb_adap.bind( fb ).solve( [ pred_prey_init( v ) for v in foodweb_adap._vars ], end_time=_sage_const_400  ) #, step=0.003 )
...
lotkavolterra.plot_aij_with_arrows( pred_prey_traj, flv, 'foodweb-pred-prey-a-vs-a.png', bindings=fb, xmin=-_sage_const_1p9955 , xmax=-_sage_const_1p9945 , ymin=_sage_const_1p795 , ymax=_sage_const_1p796  )
