# This file was *autogenerated* from the file r-selection.sage
from sage.all_cmdline import *   # import sage library
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1)# requires: r_selection.py masel_model.py
# produces: masel-replicator.tex r-selection.tex
from sage.all import *
import dynamicalsystems
import masel_model, r_selection

mm = masel_model.MaselModel(_sage_const_2 )
...
rsel = r_selection.ReplicatorDynamics( masel_model.MaselModel( _sage_const_2 , K=dynamicalsystems.indexer( lambda x:oo ) ) )

ltx = dynamicalsystems.latex_output( 'r-selection.tex' )
ltx.write( rsel )
ltx.close()

rsel = r_selection.ReplicatorDynamics( masel_model.MaselModel( _sage_const_1 , K=dynamicalsystems.indexer( lambda x:oo ) ) )
