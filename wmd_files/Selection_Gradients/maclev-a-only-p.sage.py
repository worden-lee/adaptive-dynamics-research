# This file was *autogenerated* from the file maclev-a-only-p.sage
from sage.all_cmdline import *   # import sage library
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_0p1 = RealNumber('0.1'); _sage_const_30 = Integer(30); _sage_const_0p05 = RealNumber('0.05')# requires: $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
...
c_timeseries.save( 'maclev-a-only-c-vs-t.png', figsize=(_sage_const_4 ,_sage_const_4 ) )
...
c_phase_plane.save( 'maclev-a-only-c-vs-c.png', figsize=(_sage_const_4 ,_sage_const_4 ) )

print 'plot total c vs u' 
sys.stdout.flush()

c_curve = plot( c_func( _sage_const_0 , _sage_const_0  ) + c_func( _sage_const_0 , _sage_const_1  ), (u_0, _sage_const_0 , _sage_const_1 ) )
c_curve += point( initial_conditions( vector( [ u_0, c_func( _sage_const_0 , _sage_const_0  ) + c_func( _sage_const_0 , _sage_const_1  ) ] ) ), color='blue', size=_sage_const_30  )
c_curve.axes_labels( [ '$u$', '$c_0(u) + c_1(u)$' ] )
c_curve.save( 'maclev-a-only-total-c-vs-u.png', figsize=(_sage_const_4 ,_sage_const_4 ), ymin=_sage_const_0  )
