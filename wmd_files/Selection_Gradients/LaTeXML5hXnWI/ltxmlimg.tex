...
% Destination maclev-1-2-zngi.sage.out.intermediate.latexml.html5
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsfonts}
\usepackage{graphicx}
...
\makeatother
\begin{document}
\beginINLINE (R_{0},R_{1})\endINLINE\clearpage
\beginDISPLAY \left[-{\left(u-1\right)}e^{{\left(3\, u^{{2}}\right)}},ue^{{\left(3\,{\left(u-1\right)}^{{2}}\right)}}\right]\endDISPLAY\clearpage
\beginDISPLAY R_{{1}}e^{{\left(-3\,{\left(u-1\right)}^{{2}}\right)}}+R_{{0}}e^{{\left(-3\, u^{{2}}\right)}}-1=0\endDISPLAY\clearpage
\beginDISPLAY -6\, R_{{1}}{\left(u-1\right)}e^{{\left(-3\,{\left(u-1\right)}^{{2}}\right)}}-6\, R_{{0}}ue^{{\left(-3\, u^{{2}}\right)}}=0\endDISPLAY\clearpage
\end{document}
