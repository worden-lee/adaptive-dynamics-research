...
% Destination maclev-1-2-adap.sage.out.intermediate.latexml.html5
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsfonts}
\usepackage{graphicx}
...
\makeatother
\begin{document}
\beginDISPLAY \begin{aligned}\displaystyle\frac{du_{{0}}}{dt}&\displaystyle=6\,{\left(\hat{X}_{{0}}u_{{0}}e^{{6}}-2\,{\left(u_{{0}}e^{{6}}+{\left(u_{{0}}e^{{3}}-e^{{3}}\right)}e^{{\left(6\, u_{{0}}\right)}}\right)}e^{{\left(3\, u_{{0}}^{{2}}\right)}}+{\left(\hat{X}_{{0}}u_{{0}}-\hat{X}_{{0}}\right)}e^{{\left(12\, u_{{0}}\right)}}\right)}\hat{X}_{{0}}e^{{\left(-6\, u_{{0}}^{{2}}-6\right)}}\end{aligned}\endDISPLAY\clearpage
\beginDISPLAY \begin{aligned}\displaystyle\frac{dX_{{0}}}{dt}&\displaystyle=-{\left({\left(X_{{0}}e^{{\left(-3\,{\left(u_{{0}}-1\right)}^{{2}}\right)}}-2\right)}e^{{\left(-3\,{\left(u_{{0}}-1\right)}^{{2}}\right)}}+{\left(X_{{0}}e^{{\left(-3\, u_{{0}}^{{2}}\right)}}-2\right)}e^{{\left(-3\, u_{{0}}^{{2}}\right)}}+1\right)}X_{{0}}\end{aligned}\endDISPLAY\clearpage
\beginDISPLAY \begin{aligned}\displaystyle\hat{u}_{{0}}&\displaystyle\to 0.50\end{aligned}\endDISPLAY\clearpage
\beginINLINE u_{\cdot}\endINLINE\clearpage
\end{document}
