# This file was *autogenerated* from the file sea-col.sage
...
sea_adap_col.bind_in_place( sea_col.interior_equilibria()[_sage_const_0 ] )
...
adap_traj.plot( 't', [ c_indexer[i] for i in sea_adap_col._popdyn_model._population_indices ] ).save( filename='sea-col-ts.svg', figsize=(_sage_const_4 ,_sage_const_3 ) )
...
ltx.write_block( sea_adap_col_formal._S[c_indexer[(seamodel.type_g,_sage_const_0 )]] > _sage_const_0  )

ltx.write( 'And for increase in host investment' )
ltx.write_block( sea_adap_col_formal._S[c_indexer[(seamodel.type_H,_sage_const_0 )]] > _sage_const_0  )
