# This file was *autogenerated* from the file maclev-2-2-c-popdyn.sage
from sage.all_cmdline import *   # import sage library
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_0p02 = RealNumber('0.02'); _sage_const_0p05 = RealNumber('0.05')# requires: maclev_2_2_defs.py
...
initial_conditions = Bindings( {
    rescomp._indexers['c'][_sage_const_0 ][_sage_const_0 ] : _sage_const_1 /_sage_const_2 ,
    rescomp._indexers['c'][_sage_const_0 ][_sage_const_1 ] : _sage_const_1 /_sage_const_4 ,
    rescomp._indexers['c'][_sage_const_1 ][_sage_const_0 ] : _sage_const_1 /_sage_const_4 ,
    rescomp._indexers['c'][_sage_const_1 ][_sage_const_1 ] : _sage_const_1 /_sage_const_2 ,
} )
...
rescomp_initial_system.plot_R_ZNGIs( filename='maclev-2-2-c-r-zngis.png', figsize=(_sage_const_4 ,_sage_const_4 ), ymin=_sage_const_0 , ymax=_sage_const_4 , xmin=_sage_const_0 , xmax=_sage_const_4  )
