...
maclev-2-2-p.sage maclev-2-2-p.sage.out maclev-2-2-p.sage.tried : $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
maclev-2-2-p.sage maclev-2-2-p.sage.out maclev-2-2-p.sage.tried : $(SageAdaptiveDynamics)/adaptivedynamics.py maclevmodels.py
