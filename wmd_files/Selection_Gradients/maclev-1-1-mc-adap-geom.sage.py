...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_1p75 = RealNumber('1.75'); _sage_const_4 = Integer(4); _sage_const_1p5 = RealNumber('1.5'); _sage_const_0p25 = RealNumber('0.25')# requires: maclevmodels.py $(SageAdaptiveDynamics)/adaptivedynamics.py maclev-1-1-adap.sobj
