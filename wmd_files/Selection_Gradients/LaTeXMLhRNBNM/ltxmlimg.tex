...
% Destination maclev-2-2-a-c-popdyn.sage.out.intermediate.latexml.html5
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsfonts}
\usepackage{graphicx}
...
\makeatother
\begin{document}
\beginDISPLAY \begin{aligned}\displaystyle\frac{dX_{{0}}}{dt}&\displaystyle=-{\left({\left(X_{{0}}c_{{00}}+X_{{1}}c_{{10}}-2\right)}c_{{00}}+{\left(X_{{0}}c_{{01}}+X_{{1}}c_{{11}}-2\right)}c_{{01}}+2\, c_{{00}}+2\, c_{{01}}-1\right)}X_{{0}}\\
\displaystyle\frac{dX_{{1}}}{dt}&\displaystyle=-{\left({\left(X_{{0}}c_{{00}}+X_{{1}}c_{{10}}-2\right)}c_{{10}}+{\left(X_{{0}}c_{{01}}+X_{{1}}c_{{11}}-2\right)}c_{{11}}+2\, c_{{10}}+2\, c_{{11}}-1\right)}X_{{1}}\end{aligned}\endDISPLAY\clearpage
\end{document}
