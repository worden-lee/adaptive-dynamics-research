# This file was *autogenerated* from the file maclev-1-2-zngi.sage
from sage.all_cmdline import *   # import sage library
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_0p98 = RealNumber('0.98'); _sage_const_0p3 = RealNumber('0.3'); _sage_const_0p02 = RealNumber('0.02'); _sage_const_30 = Integer(30)# requires: maclev_1_2_defs.py maclev-1-2-adap.sobj
