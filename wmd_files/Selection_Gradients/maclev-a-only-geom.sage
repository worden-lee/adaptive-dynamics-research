...
# requires: maclev_a_only_defs.py maclev-a-only-adap.sobj
# produces: maclev-a-only-geom.sage.out.tex
# produces: maclev-a-only-k-vs-t.png maclev-a-only-a-vs-t.png
# produces: maclev-a-only-Xhat-vs-t.png maclev-a-only-Rhat-vs-t.png
# produces: maclev-a-only-a-vs-a.png
# produces: maclev-a-only-a-vs-k.png maclev-a-only-a-arrows.png
from maclev_a_only_defs import *
from lotkavolterra import *

load_session( 'maclev-a-only-adap' )

ltx = latex_output( 'maclev-a-only-geom.sage.out.tex' )
...
k_timeseries.save( 'maclev-a-only-k-vs-t.png' )
...
a_timeseries.save( 'maclev-a-only-a-vs-t.png' )
...
X_timeseries.save( 'maclev-a-only-Xhat-vs-t.png' )
...
R_timeseries.save( 'maclev-a-only-Rhat-vs-t.png' )
...
a_phase_plane.save( 'maclev-a-only-a-vs-a.png', figsize=(4,4), xmax=0, ymax=0 )

#stop there for now
ltx.close()
save_session('maclev-a-only-geom')
sys.exit()
...
a_phase_plane_annotated.save( 'maclev-a-only-a-arrows.png', figsize=(8,8)
