# This file was *autogenerated* from the file sea-adap.sage
from sage.all_cmdline import *   # import sage library
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0)# requires: sea.sobj
...
sea_f = SeaSymbiosisModel(
	x_indices=[(type_H,_sage_const_0 ),(type_g,_sage_const_0 )],
...
sea_adap_f = AdaptiveDynamicsModel( 
    ...
    late_bindings = Bindings( gamma=_sage_const_1  )
)
