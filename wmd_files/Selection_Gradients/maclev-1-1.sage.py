# This file was *autogenerated* from the file maclev-1-1.sage
from sage.all_cmdline import *   # import sage library
_sage_const_0 = Integer(0)# requires: maclevmodels.py $(SageDynamics)/dynamicalsystems.py
...
rescomp = ResourceCompetitionModel(x_indices=[_sage_const_0 ], r_indices=[_sage_const_0 ])
