...
ltx.write( dgroup(
      [ [ SR('A'),
	  lv_ass.A_pair( (seamodel.type_g,_sage_const_0 ), (seamodel.type_H,_sage_const_0 ) )
	],
	[ SR('S'),
	...
	[ SR('D'),
	  ...
	  lv_ass_n.D_pair( (seamodel.type_g,_sage_const_0 ), (seamodel.type_H,_sage_const_0 ) ).apply_map( latex_partials_representation() )
	],
	[ SR.symbol('I'),
	  lv_ass.I_pair( (seamodel.type_g,_sage_const_0 ), (seamodel.type_H,_sage_const_0 ) ).apply_map( latex_partials_representation() ),
	  lv_ass_n.I_pair( (seamodel.type_g,_sage_const_0 ), (seamodel.type_H,_sage_const_0 ) ).apply_map( latex_partials_representation() )
	],
	[ SR('dA/dt'),
