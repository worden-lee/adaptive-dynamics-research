...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4)# requires: $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
