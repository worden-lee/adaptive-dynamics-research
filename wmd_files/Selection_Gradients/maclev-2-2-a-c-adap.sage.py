# This file was *autogenerated* from the file maclev-2-2-a-c-adap.sage
from sage.all_cmdline import *   # import sage library
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_0p001 = RealNumber('0.001')# requires: $(SageDynamics)/dynamicalsystems.py
...
try:
    ...
    try:
	integrate_adapdyn_step = _sage_const_0p001 
