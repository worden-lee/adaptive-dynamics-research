...
foodweb-2-2.plot.sage foodweb-2-2.plot.sage.out foodweb-2-2.plot.sage.tried : $(SageDynamics)/dynamicalsystems.py $(SageAdaptiveDynamics)/adaptivedynamics.py
foodweb-2-2.plot.sage foodweb-2-2.plot.sage.out foodweb-2-2.plot.sage.tried : $(SageUtils)/latex_output.py lotkavolterra.py
