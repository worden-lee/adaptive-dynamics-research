...
direct-assemble-plot.sage direct-assemble-plot.sage.out direct-assemble-plot.sage.tried : $(SageDynamics)/dynamicalsystems.py
direct-assemble-plot.sage direct-assemble-plot.sage.out direct-assemble-plot.sage.tried : $(SageUtils)/latex_output.py
