...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_0p02 = RealNumber('0.02'); _sage_const_0p05 = RealNumber('0.05'); _sage_const_50 = Integer(50)# requires: maclev_2_2_defs.py
...
s = maclev_initial_system.solve( [_sage_const_0 , _sage_const_0p02 , _sage_const_0p05 ], end_points=_sage_const_50  )
