...
_sage_const_3 = Integer(3); _sage_const_0p1 = RealNumber('0.1'); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)# requires: foodweb.py
...
pred_prey_init = dynamicalsystems.Bindings( { 'u_a_0':_sage_const_0p1 , 'u_b_0':_sage_const_0  } ) 
