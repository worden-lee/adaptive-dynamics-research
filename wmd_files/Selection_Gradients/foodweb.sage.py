...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_9 = Integer(9); _sage_const_0p1 = RealNumber('0.1'); _sage_const_10 = Integer(10); _sage_const_1000 = Integer(1000)# requires: foodweb.py
