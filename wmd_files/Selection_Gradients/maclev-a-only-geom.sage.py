# This file was *autogenerated* from the file maclev-a-only-geom.sage
...
a_phase_plane.save( 'maclev-a-only-a-vs-a.png', figsize=(_sage_const_4 ,_sage_const_4 ), xmax=_sage_const_0 , ymax=_sage_const_0  )
...
a_phase_plane_annotated.save( 'maclev-a-only-a-arrows.png', figsize=(_sage_const_8 ,_sage_const_8 )
