...
% Destination maclev-1-1.sage.out.intermediate.latexml.html5
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsfonts}
\usepackage{graphicx}
...
\makeatother
\begin{document}
\beginDISPLAY \begin{aligned}\displaystyle\frac{dX_{{0}}}{dt}&\displaystyle=-{\left(\frac{{\left(X_{{0}}c_{{00}}-K_{{0}}r_{{0}}\right)}c_{{00}}w_{{0}}}{r_{{0}}}+m_{{0}}\right)}X_{{0}}b_{{0}}\end{aligned}\endDISPLAY\clearpage
\beginDISPLAY \begin{aligned}\displaystyle\frac{dR_{{0}}}{dt}&\displaystyle=-X_{{0}}c_{{00}}+{\left(K_{{0}}-R_{{0}}\right)}r_{{0}}\\
\displaystyle\frac{dX_{{0}}}{dt}&\displaystyle={\left(R_{{0}}c_{{00}}w_{{0}}-m_{{0}}\right)}X_{{0}}b_{{0}}\end{aligned}\endDISPLAY\clearpage
\end{document}
