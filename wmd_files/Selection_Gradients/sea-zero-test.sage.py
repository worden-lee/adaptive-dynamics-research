# This file was *autogenerated* from the file sea-zero-test.sage
...
sea_adap_zero.bind_in_place( sea_zero.interior_equilibria()[_sage_const_0 ] )
...
adap_traj.plot( 't', sea_adap_zero._vars ).save( filename='sea-zero-ts.svg', figsize=(_sage_const_4 ,_sage_const_3 ) )
