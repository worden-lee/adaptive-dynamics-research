...
c_timeseries.save( 'maclev-2-2-c-vs-t.png', figsize=(_sage_const_4 ,_sage_const_4 ) )
...
c_phase_plane.save( 'maclev-2-2-c-vs-c.png', figsize=(_sage_const_4 ,_sage_const_4 ) )
...
c_curve += point( initial_conditions( vector( [ u_1, c_func( _sage_const_1 , _sage_const_0  ) + c_func( _sage_const_1 , _sage_const_1  ) ] ) ), color='red', size=_sage_const_30  )
c_curve.axes_labels( [ '$u$', '$c_0(u) + c_1(u)$' ] )
c_curve.save( 'maclev-2-2-total-c-vs-u.png', figsize=(_sage_const_4 ,_sage_const_4 ), ymin=_sage_const_0  )
