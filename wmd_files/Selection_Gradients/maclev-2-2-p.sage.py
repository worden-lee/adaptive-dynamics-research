...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4); _sage_const_0p1 = RealNumber('0.1'); _sage_const_30 = Integer(30); _sage_const_0p05 = RealNumber('0.05')# requires: $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
