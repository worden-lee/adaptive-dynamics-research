...
maclev-a-only-p.sage maclev-a-only-p.sage.out maclev-a-only-p.sage.tried : $(SageDynamics)/dynamicalsystems.py $(SageUtils)/latex_output.py
maclev-a-only-p.sage maclev-a-only-p.sage.out maclev-a-only-p.sage.tried : $(SageAdaptiveDynamics)/adaptivedynamics.py maclevmodels.py
