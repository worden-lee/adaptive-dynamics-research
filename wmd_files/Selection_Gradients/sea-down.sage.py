...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_0p08 = RealNumber('0.08'); _sage_const_0p04 = RealNumber('0.04')# requires: sea-adap.sobj
...
starting_comm.bind_in_place( x_a_0=_sage_const_0p04 , X_t_0=-_sage_const_0p08  )
