...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_10 = Integer(10)# requires: maclevmodels.py maclev-1-1.sobj
...
c_evolution = maclev_adap_bound.solve( [initial_u], end_time=_sage_const_10  )
