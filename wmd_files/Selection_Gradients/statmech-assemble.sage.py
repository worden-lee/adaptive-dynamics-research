# This file was *autogenerated* from the file statmech-assemble.sage
from sage.all_cmdline import *   # import sage library
_sage_const_100 = Integer(100); _sage_const_1e7 = RealNumber('1e+7'); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_0p001 = RealNumber('0.001')# requires: statmech.py
